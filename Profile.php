			...
			<form id="myForm" action="php/Register.php" method="POST" class="user" enctype="multipart/form-data">
				<div class="col-md-9 col-sm-push-1">
					<div class="form-style-1 user-pro" action="#">
						<h1 align="center" style="color: white;">User Profile :</h1>
						<div class="user-information">
							<div class="user-img">
								...
								<label for="file" class="redbtn" id="upload_link" style="cursor: pointer;color: white;">Upload Image</label>
								<script>
						...
						<h4>You Can Change Your Account Details Below...</h4>
						<div class="row">
